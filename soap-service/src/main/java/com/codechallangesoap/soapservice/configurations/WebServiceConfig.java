package com.codechallangesoap.soapservice.configurations;
...
public class WebServiceConfig extends WsConfigurerAdapter {
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema clientesSchema) {
		...
		wsdl11Definition.setTargetNamespace("http://www.codechallange.com/");
	...
	public XsdSchema clientesSchema() {
		return new SimpleXsdSchema(new ClassPathResource("xsds/clientes.xsd"));
	}
